...
try:
    ...
    # testing
    ipr_files = "resource/6_superfamily/glycan/SearchResults*"

    out_file = "data/superfamily/1_signature_iprs/glycan/signature_iprs_{}.tsv"  # lrr, cystine, ankyrin
...
for key, value in family.items():
    ...
    ipr_dict[key[2]] = ipr[ipr["Description"].str.contains(key[2], na=False, case=False)]
